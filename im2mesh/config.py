...
from im2mesh import onet_conv, onet, r2n2, psgn, pix2mesh,onet_upconv2d_occtolocal, onet_upconv2d, onet_IP_input, onet_upconv2d_ctof
...
method_dict = {
    ...
    'pix2mesh': pix2mesh,
    # 'dmc': dmc,
    'onet_upconv2d' : onet_upconv2d,
    'onet_IP_input' : onet_IP_input,
    'onet_upconv2d_ctof' : onet_upconv2d_ctof,
    'onet_upconv2d_occtolocal' : onet_upconv2d_occtolocal,
...
def get_inputs_field(mode, cfg):
    ...
    if input_type is None:
    ...
    elif input_type == 'imagewithpointcloud':
        if mode == 'train' and cfg['data']['img_augment']:
                    resize_op = transforms.RandomResizedCrop(
                        cfg['data']['img_size'], (0.75, 1.), (1., 1.))
        else:
        ...
        with_transforms_P = cfg['data']['with_transforms']
        inputs_field = data.imagewithpointcloud(
            cfg['data']['pointcloud_file'], transform_P,
            with_transforms_P=with_transforms_P,
            folder_name_I=cfg['data']['img_folder'], transform_I=transform_I,
            with_camera_I=with_camera, random_view_I=random_view,
        )
    # elif input_type == 'imagewithpointcloud':
    #     # if mode == 'train' and cfg['data']['img_augment']:
    #     #     resize_op = transforms.RandomResizedCrop(
    ...
    #     # print("cfg['data']['pointcloud_noise']",cfg['data']['pointcloud_noise'])
    ...
    #     # print("cfg['data']['img_folder']",cfg['data']['img_folder'])
    #     # exit(1)
    #     inputs_field = data.ImagewithPointCloudField(
    #         # folder_name_I=cfg['data']['img_folder'], transform_I=transform_I,
    #         # with_camera_I=with_camera, random_view_I=random_view,
    #         file_name_P=cfg['data']['pointcloud_file'], transform_P=transform_P,
    #         with_transforms_P=with_transforms_P
    #     )
