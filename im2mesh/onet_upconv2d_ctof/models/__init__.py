...
from im2mesh.onet_upconv2d_ctof.models import encoder_latent, decoder
from im2mesh.onet_upconv2d_ctof.layers import GraphProjection
...
class OccupancyNetwork(nn.Module):
    ...
    def forward(self, p, inputs, world_mat, camera_mat, sample=True, **kwargs):
        ...
        p_r = self.decode(p, z, v, G, **kwargs)
        return p_r
    ...
    def decode(self, p, z, v, G, **kwargs):
        ...
        logits = self.decoder(p, z, v, G, **kwargs)
